...
Public Class frmPaymentVoucher
    Const VoucherType As String = "CPV"
    Const MasterTable As String = "tblAccPaymentVoucherMaster"
    Const DetailTable As String = "tblAccPaymentVoucherDetail"
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        If txtAccCodeMaster.Text = Nothing Then
            MsgBox("Please Enter Valid Payment Account Code")
            txtAccTitleMaster.Focus()
            Exit Sub
        End If
    ...
    Sub ShowAccSearchDialog(ByVal Source As String)
        ...
        If Source = "Master" Then
            If cboVoucherType.SelectedItem = "BPV" Then
                InitialValue1 = "BPVMaster"
                InitialValue2 = "Bank"

            Else
                InitialValue1 = "CPVMaster"
                InitialValue2 = "Cash"
    ...
    Sub FillTransactions()
        ...
        With cmd
            .Connection = Conn
            .CommandText = "SELECT dbo.tblAccPaymentVoucherDetail.DetailId, dbo.tblAccPaymentVoucherDetail.VoucherId, dbo.tblAccPaymentVoucherDetail.AccCode, dbo.tblAccPaymentVoucherDetail.Description, dbo.tblAccPaymentVoucherDetail.Amount, dbo.tblAccPaymentVoucherDetail.SysTimeStamp, dbo.tblAccChartOfAccounts.AccName FROM dbo.tblAccPaymentVoucherDetail INNER JOIN dbo.tblAccChartOfAccounts ON dbo.tblAccPaymentVoucherDetail.AccCode = dbo.tblAccChartOfAccounts.AccCode WHERE VoucherId = @VoucherId"
            .Parameters.Clear()
            .Parameters.Add("@VoucherId", SqlDbType.NVarChar).Value = txtVoucherId.Text
        End With
        dt.Clear()
