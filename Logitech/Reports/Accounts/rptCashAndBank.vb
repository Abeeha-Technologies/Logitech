...
Public Class rptCashAndBank
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Logitech.rptCashAndBank.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCashAndBank
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCashAndBank = New rptCashAndBank()
        rpt.Site = Me.Site
        Return rpt
    End Function
