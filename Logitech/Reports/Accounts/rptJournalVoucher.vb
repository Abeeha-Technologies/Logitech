...
Public Class rptJournalVoucher
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Logitech.rptJournalVoucher.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_VoucherTitle() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptJournalVoucher
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptJournalVoucher = New rptJournalVoucher()
        rpt.Site = Me.Site
        Return rpt
    End Function
