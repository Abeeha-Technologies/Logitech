...
Public Class rptReceivables
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Logitech.rptReceivables.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReceivables
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReceivables = New rptReceivables()
        rpt.Site = Me.Site
        Return rpt
    End Function
