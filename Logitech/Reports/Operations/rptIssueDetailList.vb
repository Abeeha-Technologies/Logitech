...
Public Class rptIssueDetailList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Logitech.rptIssueDetailList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptIssueDetailList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptIssueDetailList = New rptIssueDetailList()
        rpt.Site = Me.Site
        Return rpt
    End Function
